...
@Component({
  ...
  templateUrl: './profileOperator.component.html',
  styleUrls: ['./profileOperator.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class DialogProfileOperatorComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogProfileOperatorComponent>,
